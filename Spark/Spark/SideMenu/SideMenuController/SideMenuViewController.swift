...
class SideMenuViewController: UIViewController {
    ...
    var menu: [SideMenuModel] = [
        ...
        SideMenuModel(icon: UIImage(systemName: "heart.fill")!, title: "Favorite"),
        SideMenuModel(icon: UIImage(systemName: "parkingsign.circle.fill")!, title: "Booked Parking slots"),
    ...
    override func viewDidLoad() {
        ...
        emailLbl.text = UserDefaults.standard.value(forKey: "emmailId") as? String ?? ""
        // TableView
